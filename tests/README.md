...
**275 suites**, discovered automatically by [`../verify.py`](../verify.py) (also runnable with
...
actually bites. Together they are the `unit-falsifiers` row of the gate: **4891 unit falsifiers, 0 red**.

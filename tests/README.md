...
**195 suites**, discovered automatically by [`../verify.py`](../verify.py) (also runnable with
...
- **Movement & observers (MMO Stages A–B)** — `test_stance`, `test_gaze`, `test_drive`,
  ...
  mould caught by refusal rather than by a replay that silently diverges).
...
actually bites. Together they are the `unit-falsifiers` row of the gate: **2575 unit falsifiers, 0 red**.

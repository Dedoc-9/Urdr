...
The gate enforcing all of the above: **519 unit falsifiers + per-layer conformance
...
on Windows and Linux. Twenty-one std-only Rust placements, twelve C99 runtimes.

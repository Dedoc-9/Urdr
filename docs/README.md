...
| Path | What it is |
|---|---|
| `PAPER.md` | **OSDI-style systems paper** for the deterministic execution pipeline — problem, layered design, implementation, and the cross-implementation reproducibility evaluation (4 independent Rust placements reproducing 36 kernel + 10 frame + 18 physics + 3 field + 20 exact-math digests, behind a 254-test gate). Scoped to corpus agreement, not universal correctness. Includes the m
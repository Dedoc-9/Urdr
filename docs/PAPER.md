...
in the netcode stack the placements agree on the *defect* digests as well. A 573-test
...
The gate runs, deterministically: **573** unit falsifiers; **42** example programs
...
bit-for-bit on fixed corpora, behind a 573-test gate with typed
refusa
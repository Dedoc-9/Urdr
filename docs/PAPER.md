...
We report a concrete reproducibility result: 34 independent, single-file Rust
...
The 34 Rust and 14 C99 placements share no code, language, or SHA-256 implementation with the
...
The gate runs, deterministically: **3149** unit falsifiers; **42** example programs
...
34 independent Rust placements (and 14 C99 runtimes) reproduce the reference's state, frame, physics,
...
bit-for-bit on fixed corpora, behind a 3149-test gate with typed
refusa
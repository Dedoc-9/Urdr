...
in the netcode stack the placements agree on the *defect* digests as well. A 474-test
...
The gate runs, deterministically: **474** unit falsifiers; **42** example programs
...
bit-for-bit on fixed corpora, behind a 474-test gate with typed
refusa
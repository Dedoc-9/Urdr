...
in the netcode stack the placements agree on the *defect* digests as well. A 390-test
...
The gate runs, deterministically: **390** unit falsifiers; **42** example programs

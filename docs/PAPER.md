...
in the netcode stack the placements agree on the *defect* digests as well. A 399-test
...
The gate runs, deterministically: **399** unit falsifiers; **42** example programs

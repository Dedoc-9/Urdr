...
We report a concrete reproducibility result: 35 independent, single-file Rust
...
The 35 Rust and 14 C99 placements share no code, language, or SHA-256 implementation with the
...
35 independent Rust placements (and 14 C99 runtimes) reproduce the reference's state, frame, physics,

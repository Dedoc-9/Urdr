...
in the netcode stack the placements agree on the *defect* digests as well. A 596-test
...
The gate runs, deterministically: **596** unit falsifiers; **42** example programs
...
bit-for-bit on fixed corpora, behind a 596-test gate with typed
refusa
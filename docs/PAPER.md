...
in the netcode stack the placements agree on the *defect* digests as well. A 562-test
...
The gate runs, deterministically: **562** unit falsifiers; **42** example programs
...
bit-for-bit on fixed corpora, behind a 562-test gate with typed
refusa
...
in the netcode stack the placements agree on the *defect* digests as well. A 586-test
...
The gate runs, deterministically: **586** unit falsifiers; **42** example programs
...
bit-for-bit on fixed corpora, behind a 586-test gate with typed
refusa
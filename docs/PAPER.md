...
in the netcode stack the placements agree on the *defect* digests as well. A 549-test
...
The gate runs, deterministically: **549** unit falsifiers; **42** example programs
...
bit-for-bit on fixed corpora, behind a 549-test gate with typed
refusa
...
in the netcode stack the placements agree on the *defect* digests as well. A 466-test
...
The gate runs, deterministically: **466** unit falsifiers; **42** example programs
...
bit-for-bit on fixed corpora, behind a 466-test gate with typed
refusa
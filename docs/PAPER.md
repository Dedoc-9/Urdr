...
in the netcode stack the placements agree on the *defect* digests as well. A 551-test
...
The gate runs, deterministically: **551** unit falsifiers; **42** example programs
...
bit-for-bit on fixed corpora, behind a 551-test gate with typed
refusa
...
We report a concrete reproducibility result: thirteen independent, single-file Rust
...
in the netcode stack the placements agree on the *defect* digests as well. A 436-test
...
The 13 Rust and 4 C99 placements share no code, language, or SHA-256 implementation with the
...
The gate runs, deterministically: **436** unit falsifiers; **42** example programs
...
bit-for-bit on fixed corpora, behind a 436-test gate with typed
refusa
...
in the netcode stack the placements agree on the *defect* digests as well. A 590-test
...
The gate runs, deterministically: **590** unit falsifiers; **42** example programs
...
bit-for-bit on fixed corpora, behind a 590-test gate with typed
refusa
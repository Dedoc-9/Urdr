...
The gate runs, deterministically: **239** unit falsifiers; **42** example programs
...
and exact-math digests bit-for-bit on fixed corpora, behind a 239-test gate with typed

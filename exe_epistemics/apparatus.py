...
def main():
    ...
    print("  doc_currency and provenance are imported by verify.py and name the arc as history")
    print("  exemptions and evidence strings. verify.py itself now names it directly: the")
    print("  `epistemics_apparatus` stage (4 rows) IMPORTS AND EXERCISES selection.py and")
    print("  apparatus.py on synthetic fixtures.")
    print()
    print("  THIS PARAGRAPH WAS STALE FOR ONE RUNG AND IS THE BRAKE FLAGGING ITSELF. It read")
    print("  'no gate row EXERCISES the code here, and that is what the new apparatus stage")
    print("  changes' — a sentence written at Rung 12 that was true when written and false the")
    print("  moment that same rung landed, because the forward-looking clause was left standing")
    print("  beside a present-tense claim. Two of the twelve modules ARE exercised by a gate row;")
    print("  the direct-PATH count above is still 0/12 because the stage imports by module name")
    print("  rather than by path, which is exactly the gap that measure was renamed to admit.")
    print("  `named accurately != read accurately`.")
    print()

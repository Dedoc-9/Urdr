...
across independent implementations or explicitly refused. **28** single-file Rust placements
...
pipeline is bit-reproducible across independent implementations** (28 Rust placements + 14 C99 runtimes agree with the Python reference on stated corpora), and **a claim cannot outrun its evidence
...
- **Third-language placements of the remaining layers.** The math spine, the whole netcode stack, and two
  detectors (toric, rigidity) are multi-runtime (Python + Rust + C99, two OSes — **28 Rust + 14 C99

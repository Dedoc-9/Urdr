...
on fixed corpora, behind a **935-test gate** — and the math spine, the netcode region, the frontfps ladder, and the toric/rigidity/homology detectors carry **14** C99 placements, so
...
- **Phase V — the MMO stage arc (what the direction became).** The work since Phase IV ran the terrain
  ...
  **RAN-0** (`rannull`: authority nullity — ownership and independence composed into a proof of
  ...
  The narrative arc so far: persistence proves replay, terraform proves locality, commutation proves
  semantic independence, chunkstate proves ownership, RAN-0 proves authority nullity. The declared arc
  ahead: the authority algebra (difference/projection/closure), n-way nullity, live authority
  migration; the queued next rung is the N2-window/durable-window unification.

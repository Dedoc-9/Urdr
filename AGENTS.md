...
and it covers 8 of the gate's 837 rows against 579s for the two required passes. That is ~1% of the
...
#     GATE=PASSED FAILROWS=0 FALS=1948/0red ROWS=837 DOCCUR=OK DOCSTALE=OK
...
# THE GATE (CI). Expect "GATE PASSED", 1948 unit falsifiers / 837 rows, and run it

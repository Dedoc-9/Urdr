...
and it covers 8 of the gate's 881 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 2085 unit falsifiers / 881 rows, and run it

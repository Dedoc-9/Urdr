...
and it covers 8 of the gate's 892 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 2172 unit falsifiers / 892 rows, and run it

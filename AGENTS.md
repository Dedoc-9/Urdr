...
and it covers 8 of the gate's 841 rows against 579s for the two required passes. That is ~1% of the
...
#     GATE=PASSED FAILROWS=0 FALS=1966/0red ROWS=841 DOCCUR=OK DOCSTALE=OK
...
# THE GATE (CI). Expect "GATE PASSED", 1966 unit falsifiers / 841 rows, and run it

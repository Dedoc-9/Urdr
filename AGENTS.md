...
and it covers 8 of the gate's 875 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 2052 unit falsifiers / 875 rows, and run it

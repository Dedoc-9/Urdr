...
and it covers 8 of the gate's 852 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 1987 unit falsifiers / 852 rows, and run it

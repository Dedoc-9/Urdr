...
and it covers 8 of the gate's 893 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 2179 unit falsifiers / 893 rows, and run it

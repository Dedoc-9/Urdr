...
and it covers 8 of the gate's 887 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 2128 unit falsifiers / 887 rows, and run it

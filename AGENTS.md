...
and it covers 8 of the gate's 858 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 2004 unit falsifiers / 858 rows, and run it

...
and it covers 8 of the gate's 896 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 3149 unit falsifiers / 1013 rows, and run it

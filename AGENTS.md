...
and it covers 8 of the gate's 885 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 2106 unit falsifiers / 885 rows, and run it

...
and it covers 8 of the gate's 876 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 2061 unit falsifiers / 876 rows, and run it

...
and it covers 8 of the gate's 890 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 2165 unit falsifiers / 890 rows, and run it

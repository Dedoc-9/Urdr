...
and it covers 8 of the gate's 895 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 2183 unit falsifiers / 895 rows, and run it

...
and it covers 8 of the gate's 883 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 2098 unit falsifiers / 883 rows, and run it

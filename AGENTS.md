...
and it covers 8 of the gate's 872 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 2039 unit falsifiers / 872 rows, and run it

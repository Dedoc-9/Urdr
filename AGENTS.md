...
and it covers 8 of the gate's 862 rows against 579s for the two required passes. That is ~1% of the
...
# THE GATE (CI). Expect "GATE PASSED", 2022 unit falsifiers / 862 rows, and run it

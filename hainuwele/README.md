...
**MEASURED, as of this writing.** 151 modules under `tools/terrain/`, 234 suites, 3393 unit
falsifiers with 0 red, 1048 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

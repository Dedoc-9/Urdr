...
**MEASURED, as of this writing.** 103 modules under `tools/terrain/`, 179 falsifier suites, 2052 unit
falsifiers with 0 red, 875 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

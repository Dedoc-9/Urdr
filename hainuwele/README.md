...
**MEASURED, as of this writing.** 134 modules under `tools/terrain/`, 216 suites, 2977 unit
falsifiers with 0 red, 989 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

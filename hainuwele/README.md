...
**MEASURED, as of this writing.** 103 modules under `tools/terrain/`, 175 falsifier suites, 1982 unit
falsifiers with 0 red, 847 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

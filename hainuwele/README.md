...
**MEASURED, as of this writing.** 145 modules under `tools/terrain/`, 227 suites, 3220 unit
falsifiers with 0 red, 1022 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

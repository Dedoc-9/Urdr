...
**MEASURED, as of this writing.** 103 modules under `tools/terrain/`, 183 falsifier suites, 2106 unit
falsifiers with 0 red, 885 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

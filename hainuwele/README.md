...
**MEASURED, as of this writing.** 131 modules under `tools/terrain/`, 213 suites, 2932 unit
falsifiers with 0 red, 980 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 147 modules under `tools/terrain/`, 229 suites, 3277 unit
falsifiers with 0 red, 1030 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

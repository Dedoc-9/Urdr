...
**MEASURED, as of this writing.** 136 modules under `tools/terrain/`, 218 suites, 3018 unit
falsifiers with 0 red, 995 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

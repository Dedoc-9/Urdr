...
**MEASURED, as of this writing.** 103 modules under `tools/terrain/`, 178 falsifier suites, 2039 unit
falsifiers with 0 red, 872 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

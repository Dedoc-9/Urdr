...
**MEASURED, as of this writing.** 152 modules under `tools/terrain/`, 235 suites, 3423 unit
falsifiers with 0 red, 1052 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 166 modules under `tools/terrain/`, 249 suites, 3930 unit
falsifiers with 0 red, 1109 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

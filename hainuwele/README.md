...
**MEASURED, as of this writing.** 130 modules under `tools/terrain/`, 212 suites, 2921 unit
falsifiers with 0 red, 977 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

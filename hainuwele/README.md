...
**MEASURED, as of this writing.** 103 modules under `tools/terrain/`, 180 falsifier suites, 2061 unit
falsifiers with 0 red, 876 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

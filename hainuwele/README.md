...
**MEASURED, as of this writing.** 157 modules under `tools/terrain/`, 240 suites, 3561 unit
falsifiers with 0 red, 1072 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

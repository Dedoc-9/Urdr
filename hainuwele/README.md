...
**MEASURED, as of this writing.** 156 modules under `tools/terrain/`, 239 suites, 3531 unit
falsifiers with 0 red, 1068 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 138 modules under `tools/terrain/`, 220 suites, 3062 unit
falsifiers with 0 red, 1001 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

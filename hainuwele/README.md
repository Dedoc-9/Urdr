...
**MEASURED, as of this writing.** 155 modules under `tools/terrain/`, 238 suites, 3501 unit
falsifiers with 0 red, 1064 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

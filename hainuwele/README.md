...
**MEASURED, as of this writing.** 150 modules under `tools/terrain/`, 233 suites, 3360 unit
falsifiers with 0 red, 1044 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

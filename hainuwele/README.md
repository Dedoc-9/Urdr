...
**MEASURED, as of this writing.** 154 modules under `tools/terrain/`, 237 suites, 3477 unit
falsifiers with 0 red, 1060 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

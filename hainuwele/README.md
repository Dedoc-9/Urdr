...
**MEASURED, as of this writing.** 140 modules under `tools/terrain/`, 222 suites, 3106 unit
falsifiers with 0 red, 1007 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

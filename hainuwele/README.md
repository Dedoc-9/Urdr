...
**MEASURED, as of this writing.** 158 modules under `tools/terrain/`, 241 suites, 3604 unit
falsifiers with 0 red, 1076 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 148 modules under `tools/terrain/`, 230 suites, 3303 unit
falsifiers with 0 red, 1034 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 146 modules under `tools/terrain/`, 228 suites, 3253 unit
falsifiers with 0 red, 1026 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

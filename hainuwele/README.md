...
**MEASURED, as of this writing.** 103 modules under `tools/terrain/`, 181 falsifier suites, 2085 unit
falsifiers with 0 red, 881 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

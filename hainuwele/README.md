...
**MEASURED, as of this writing.** 103 modules under `tools/terrain/`, 182 falsifier suites, 2098 unit
falsifiers with 0 red, 883 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

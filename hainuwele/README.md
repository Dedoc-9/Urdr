...
**MEASURED, as of this writing.** 141 modules under `tools/terrain/`, 223 suites, 3129 unit
falsifiers with 0 red, 1010 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
| [`pixelcost.py`](../tools/terrain/pixelcost.py) | `URDRPXC1` | The resolution decision derived from four committed probe records — chord-tested form, dual-slot budgets, lawful demotion, no extrapolation | `pixelcost` | [test](../tests/test_pixelcost.py) | [conf](../tools/terrain/conformance_pixelcost.txt) | [brief](../docs/pixelcost_brief.md) |
...
**MEASURED, as of this writing.** 128 modules under `tools/terrain/`, 210 suites, 2895 unit

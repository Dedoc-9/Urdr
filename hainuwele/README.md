...
**MEASURED, as of this writing.** 103 modules under `tools/terrain/`, 176 falsifier suites, 2002 unit
falsifiers with 0 red, 858 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 144 modules under `tools/terrain/`, 226 suites, 3196 unit
falsifiers with 0 red, 1019 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

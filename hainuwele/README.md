...
**MEASURED, as of this writing.** 103 modules under `tools/terrain/`, 172 falsifier suites, 1931 unit
falsifiers with 0 red, 836 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 165 modules under `tools/terrain/`, 248 suites, 3889 unit
falsifiers with 0 red, 1105 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

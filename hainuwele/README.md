...
**MEASURED, as of this writing.** 162 modules under `tools/terrain/`, 245 suites, 3772 unit
falsifiers with 0 red, 1093 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 161 modules under `tools/terrain/`, 244 suites, 3733 unit
falsifiers with 0 red, 1089 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 163 modules under `tools/terrain/`, 246 suites, 3812 unit
falsifiers with 0 red, 1097 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

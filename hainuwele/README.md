...
**MEASURED, as of this writing.** 160 modules under `tools/terrain/`, 243 suites, 3688 unit
falsifiers with 0 red, 1084 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

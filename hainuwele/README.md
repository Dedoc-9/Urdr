...
**MEASURED, as of this writing.** 167 modules under `tools/terrain/`, 250 suites, 3976 unit
falsifiers with 0 red, 1113 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

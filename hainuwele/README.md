...
**MEASURED, as of this writing.** 139 modules under `tools/terrain/`, 221 suites, 3082 unit
falsifiers with 0 red, 1004 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 103 modules under `tools/terrain/`, 185 falsifier suites, 2165 unit
falsifiers with 0 red, 890 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

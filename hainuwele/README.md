...
**MEASURED, as of this writing.** 153 modules under `tools/terrain/`, 236 suites, 3448 unit
falsifiers with 0 red, 1056 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

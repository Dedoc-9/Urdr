...
**MEASURED, as of this writing.** 103 modules under `tools/terrain/`, 184 falsifier suites, 2122 unit
falsifiers with 0 red, 887 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 135 modules under `tools/terrain/`, 217 suites, 2997 unit
falsifiers with 0 red, 992 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 143 modules under `tools/terrain/`, 225 suites, 3178 unit
falsifiers with 0 red, 1016 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

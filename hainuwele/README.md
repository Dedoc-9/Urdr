...
**MEASURED, as of this writing.** 164 modules under `tools/terrain/`, 247 suites, 3853 unit
falsifiers with 0 red, 1101 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

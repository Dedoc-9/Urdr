...
| [`armpair.py`](../tools/terrain/armpair.py) | `URDRARM1` | The equality OUTLIVES the code that proved it — v1.19's retained recomputation is retired, and the sixteen committed records keep D_reference(f) = D_incremental(f) as a comparison of bytes; the cost effect is separated against a band DERIVED from the null cells rather than declared | `armpair` | [test](../tests/test_armpair.py) | [conf](../tools/terrain/conformance_armpair.txt) | [brief](../docs/armpair_brief.md) |
...
**MEASURED, as of this writing.** 142 modules under `tools/terrain/`, 224 suites, 3149 unit

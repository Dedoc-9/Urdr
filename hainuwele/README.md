...
**MEASURED, as of this writing.** 142 modules under `tools/terrain/`, 224 suites, 3159 unit
falsifiers with 0 red, 1013 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 103 modules under `tools/terrain/`, 174 falsifier suites, 1970 unit
falsifiers with 0 red, 843 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

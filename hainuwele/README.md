...
**MEASURED, as of this writing.** 149 modules under `tools/terrain/`, 231 suites, 3325 unit
falsifiers with 0 red, 1038 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

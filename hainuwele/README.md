...
**MEASURED, as of this writing.** 137 modules under `tools/terrain/`, 219 suites, 3040 unit
falsifiers with 0 red, 998 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

...
**MEASURED, as of this writing.** 159 modules under `tools/terrain/`, 242 suites, 3641 unit
falsifiers with 0 red, 1080 gate rows, 0 FAIL. The gate prints `GATE PASSED` twice byte-identically

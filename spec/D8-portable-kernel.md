...
ADMITTED 12/12 twice on 2026-07-07, **v4 reference-frozen — Rust ADMITTED 15/15 pending**) — that host; whole-corpus admission stays the SCOPED strengthening. `admitted ≠ trusted`.

...
corpus — grown to **22** vectors (v2 = fixpoint foundation, v3 = division-free `mul`, v4 = `div`, v5 = `floor_int`+`sqrt`, v6 = observer atlas injectivity; v2+v3 re-
ADMITTED 12/12 twice on 2026-07-07, **v4/v5 Rust ADMITTED 20/20 twice, defect caught 9/9, 2026-07-07; v6 Rust ADMITTED 22/22 twice, defect caught 10/10, 2026-07-07**) — that host; whole-corpus admission stays the SCOPED strengthening. `admitted ≠ trusted`.

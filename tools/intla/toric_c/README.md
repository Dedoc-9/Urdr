...
# tools/intla/toric_c — C99 placement of `tools/intla toric detector`

## Index

- `toric.c` — the single translation unit: an independent C99 re-implementation of
...
real only if an *independent* implementation reproduces it bit-for-bit. It reproduces the toric digest and the invariant k = dim H1 = 2*genus, bit-for-bit. The pinned
...
- Build & run: `cc -O2 -std=c99 -Wall -Wextra toric.c -o toric && ./toric`

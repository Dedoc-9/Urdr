...
# tools/frontfps/frontcanon_c — C99 placement of `tools/frontfps/frontfps.py`

## Index

- `frontcanon.c` — the single translation unit: an independent C99 re-implementation of
...
real only if an *independent* implementation reproduces it bit-for-bit. Built from world DATA (not a canned string) it reproduces world_digest crate_solo 6c4c807f and arena_duel 0c9ec33a plus the provenance-fold defect. The pinned
...
- Build & run: `cc -O2 -std=c99 -Wall -Wextra frontcanon.c -o frontcanon && ./frontcanon`

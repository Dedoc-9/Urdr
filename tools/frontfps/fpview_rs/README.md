...
# tools/frontfps/fpview_rs — Rust placement of `tools/frontfps/frontfps_view.py`

## Index

- `frontfps_view.rs` — the single translation unit: an independent Rust re-implementation of
...
real only if an *independent* implementation reproduces it bit-for-bit. It reproduces the view-stream golden bc60023 and the fold-defect d5ea65e on Windows/rustc. The pinned
...
- Build & run: `rustc -O frontfps_view.rs -o fpview && ./fpview`

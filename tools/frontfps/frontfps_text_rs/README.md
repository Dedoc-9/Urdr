...
# tools/frontfps/frontfps_text_rs — Rust placement of `tools/frontfps/frontfps_text.py`

## Index

- `frontfps_text.rs` — the single translation unit: an independent Rust re-implementation of
...
real only if an *independent* implementation reproduces it bit-for-bit. It reproduces text_canon 2718c63e and the full fuzz-outcome digest e57dfaea on Windows/rustc (257 inputs classify identically across 3 implementations). The pinned
...
- Build & run: `rustc -O frontfps_text.rs -o fptext && ./fptext`

...
# tools/frontfps/fppose_rs — Rust placement of `tools/frontfps/fppose.py`

## Index

- `fppose.rs` — the single translation unit: an independent Rust re-implementation of
...
real only if an *independent* implementation reproduces it bit-for-bit. It reproduces the posed golden fee3c118 and the swapped-compose defect 04f23abe on the owner's Windows host. The pinned
...
- Build & run: `rustc -O fppose.rs -o fppose && ./fppose`

...
# tools/frontfps/fpclip_rs — Rust placement of `tools/frontfps/fpclip.py`

## Index

- `fpclip.rs` — the single translation unit: an independent Rust re-implementation of
...
real only if an *independent* implementation reproduces it bit-for-bit. It reproduces walk_pose 73b763f8, the arena trace, and the defect digest 1e6b480c, std-only, on Windows/rustc. The pinned
...
- Build & run: `rustc -O fpclip.rs -o fpclip && ./fpclip`

...
(`../verify.py`): **2492 unit falsifiers / 932 rows**, run twice, bit-identical.
...
- Run the whole gate from the repo root: `PYTHONHASHSEED=0 PYTHONUTF8=1 python verify.py`
  (expect `GATE PASSED` — 2492 unit falsifiers / 932 rows). Each module's README documents running it standalone.

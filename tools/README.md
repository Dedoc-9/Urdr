...
(`../verify.py`): **1746 unit falsifiers / 791 rows**, run twice, bit-identical.
...
- Run the whole gate from the repo root: `PYTHONHASHSEED=0 PYTHONUTF8=1 python verify.py`
  (expect `GATE PASSED` — 1746 unit falsifiers / 791 rows). Each module's README documents running it standalone.

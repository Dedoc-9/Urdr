...
(`../verify.py`): **1948 unit falsifiers / 837 rows**, run twice, bit-identical.
...
- Run the whole gate from the repo root: `PYTHONHASHSEED=0 PYTHONUTF8=1 python verify.py`
  (expect `GATE PASSED` — 1948 unit falsifiers / 837 rows). Each module's README documents running it standalone.

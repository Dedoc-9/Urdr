...
(`../verify.py`): **1892 unit falsifiers / 825 rows**, run twice, bit-identical.
...
- Run the whole gate from the repo root: `PYTHONHASHSEED=0 PYTHONUTF8=1 python verify.py`
  (expect `GATE PASSED` — 1892 unit falsifiers / 825 rows). Each module's README documents running it standalone.

...
(`../verify.py`): **2322 unit falsifiers / 913 rows**, run twice, bit-identical.
...
- Run the whole gate from the repo root: `PYTHONHASHSEED=0 PYTHONUTF8=1 python verify.py`
  (expect `GATE PASSED` — 2322 unit falsifiers / 913 rows). Each module's README documents running it standalone.

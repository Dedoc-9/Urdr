...
(`../verify.py`): **3151 unit falsifiers / 1013 rows**, run twice, bit-identical.
...
- Run the whole gate from the repo root: `PYTHONHASHSEED=0 PYTHONUTF8=1 python verify.py`
  (expect `GATE PASSED` — 3151 unit falsifiers / 1013 rows). Each module's README documents running it standalone.

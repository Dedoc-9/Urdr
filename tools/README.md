...
(`../verify.py`): **1620 unit falsifiers / 770 rows**, run twice, bit-identical.
...
- Run the whole gate from the repo root: `PYTHONHASHSEED=0 PYTHONUTF8=1 python verify.py`
  (expect `GATE PASSED` — 1620 unit falsifiers / 770 rows). Each module's README documents running it standalone.

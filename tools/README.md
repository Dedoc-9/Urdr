...
(`../verify.py`): **4089 unit falsifiers / 1121 rows**, run twice, bit-identical.
...
- Run the whole gate from the repo root: `PYTHONHASHSEED=0 PYTHONUTF8=1 python verify.py`
  (expect `GATE PASSED` — 4089 unit falsifiers / 1121 rows). Each module's README documents running it standalone.

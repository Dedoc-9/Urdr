...
(`../verify.py`): **1827 unit falsifiers / 811 rows**, run twice, bit-identical.
...
- Run the whole gate from the repo root: `PYTHONHASHSEED=0 PYTHONUTF8=1 python verify.py`
  (expect `GATE PASSED` — 1827 unit falsifiers / 811 rows). Each module's README documents running it standalone.
